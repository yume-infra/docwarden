---
name: ym-harness-smoke
description: 创建或修改 AI harness skill、contexta pack、repo-local Codex skill、plugin
  export 或 workflow helper script 后使用；跑最小真实验证并报告可用命令和粗糙点。不替代大范围代码变更后的 full CI。
---
