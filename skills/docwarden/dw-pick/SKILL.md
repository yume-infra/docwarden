...
```bash
rtk apps/isomorph/dist/index.js primitive skill .isomorph/mapping/docwarden/modules/skill-primitive/dw-pick.md --json
rtk python3 skills/primitive/write-skill/scripts/quick_validate.py skills/docwarden/dw-pick
```
