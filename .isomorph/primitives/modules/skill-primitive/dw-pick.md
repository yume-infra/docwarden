...
- Run `apps/isomorph/dist/index.js primitive skill .isomorph/primitives/modules/skill-primitive/dw-pick.md --json` and require `status: ready`.
- Run `python3 .contexta/packs/isomorph-authoring/skills/skill-creator/scripts/quick_validate.py .contexta/packs/docwarden/skills/pick` after materializing the skill.
