...
- `.isomorph/grammars/policy/template-boundary-policy.md`
- `.isomorph/grammars/policy/template-must-not-own-lifecycle.md`
...
- `.isomorph/grammars/policy/template-boundary.md`
