...
- [[primitives/modules/concept/structure|structure]]：workflow 是 structure 的一种。
- [[primitives/modules/concept/structure/pipeline|pipeline]]：workflow 与 pipeline 相邻。
- [[primitives/modules/concept/template|template]]：workflow 有 template。
```
...
```md
| [[primitives/modules/concept/structure|structure]] | workflow 属于 structure。 |
```
...
```md
| [[primitives/modules/concept/structure/pipeline|pipeline]] | workflow 表达推进；pipeline 表达转换。 |
```
