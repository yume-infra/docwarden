...
- `.isomorph/grammars/modules/policy/template-boundary-policy.md`
- `.isomorph/grammars/modules/policy/template-must-not-own-lifecycle.md`
...
- `.isomorph/grammars/modules/policy/template-boundary.md`
