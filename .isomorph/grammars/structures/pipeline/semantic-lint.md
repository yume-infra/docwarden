...
- signal modules：
  ...
  - [[lint/signal/architecture-as-responsibility-card|architecture-as-responsibility-card]]
...
- locator target：带有 `^<prefix>-<number>` marker 的 [[primitives/concept/assertion|assertion]]。
...
2. [[primitives/concept/signal|signal]] definition 命名语义偏移风险，并产生 signal。
...
本文件是 semantic-lint 的 pipeline structure，不重新定义 [[primitives/concept/semantic-lint|semantic-lint]]。
