...
agent 准备把 template 边界规则写进 `.isomorph/mapping/bootstrap/templates/policy.md`。
...
```md
这是真实规则，应进入 `.isomorph/mapping/bootstrap/modules/policy/template-boundary.md`。template 只能保留占位骨架。
```
