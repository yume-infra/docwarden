...
- `.isomorph/mapping/bootstrap/modules/policy/template-boundary-policy.md`
- `.isomorph/mapping/bootstrap/modules/policy/template-must-not-own-lifecycle.md`
...
- `.isomorph/mapping/bootstrap/modules/policy/template-boundary.md`
