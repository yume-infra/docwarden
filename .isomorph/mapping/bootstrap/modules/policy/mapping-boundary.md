...
- contexta 的语义映射（如 user-context / capability）MUST 放在 `.isomorph/mapping/contexta/` 下。
- docwarden 的 workflow definition 映射（定义层）MUST 放在 `.isomorph/mapping/docwarden/` 下。
...
```md
`.isomorph/mapping/contexta/modules/concept/user-context.md`
```
