...
agent 准备把 template 边界规则写进 `apps/isomorph/language/grammar/template/policy.md`。
...
```md
这是真实规则，应进入 `apps/isomorph/language/grammar/policy/template-boundary.md`。template 只能保留占位骨架。
```
