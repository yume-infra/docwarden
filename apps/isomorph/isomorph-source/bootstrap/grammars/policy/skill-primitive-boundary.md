...
- skill primitive MUST model review gates as Workflow moves, and SHOULD use [[basis/primitives/concept/lead-review|lead-review]] when user review is needed.
...
- root isomorph primitive catalog MUST NOT become canonical storage for concrete skill contracts.
