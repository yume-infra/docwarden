...
- `apps/isomorph/isomorph-source/basis/grammars/policy/template-boundary-policy.md`
- `apps/isomorph/isomorph-source/basis/grammars/policy/template-must-not-own-lifecycle.md`
...
- `apps/isomorph/isomorph-source/basis/grammars/policy/template-boundary.md`
