...
description: 用于创建或更新 Codex skill、把 skill-primitive material 派生成
  SKILL.md/repo-skill/plugin skill，或修正漂移成 generic scaffolding、CLI wrapper、膨胀
  docs、trigger 不清、缺少 lead-review gate、未验证 artifact 的 skill；不用于只安装 skill、只跑脚本或只写
  docs/prompt。
---
