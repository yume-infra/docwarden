...
- `.contexta/modules/concept/module.md` 是 module。
- `.contexta/modules/policy/semantic-granularity.md` 是 module。
...
- 修订 `.contexta/modules/concept/module.md`：把 module 明确为 md file scope。
