...
本文件是 module / assertion 的 composition instance，不重新定义 [[mapping/bootstrap/modules/concept/module|module]] 或 [[mapping/bootstrap/modules/concept/assertion|assertion]]。
