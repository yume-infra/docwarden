---
name: skill-improver
description: 当用户点名 skill-improver 并给出一个 target skill 或指出现有 skill 的 trigger、读取策略、boundary、workflow 偏差时使用；把目标 skill 改成最小可验证 patch。不用于从零创建新 skill 或普通 code review。
---
