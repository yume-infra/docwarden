---
name: harness-wire
description: 当需要把 agent behavior、workflow shortcut 或粗糙 prompt pattern 接成 repo-local Codex skill 或 contexta 分发的 AI harness 工具时使用；优先走现有 contexta export 和 skill validation。不用于普通 prose prompt 或 unsupported runtime surface。
---
